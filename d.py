...
Official Channel :- https://t.me/+OnS1TJanY2k5NjI9
'''
...
➡️ To START BAD BOY ATTACK : /bgmi
    
➡️ To Run This Command : /settings 

➡️ Join Telegram :- https://t.me/+OnS1TJanY2k5NjI9
...
def set_bot_commands():
    ...
    BotCommand("id", "Get User ID"),
        ...
        BotCommand("bgmi", "START VKP ATTACK"),
...
def create_user_keyboard():
    ...
    button1 = KeyboardButton("⚔️ START 🔥VKP🔥 ATTACK ⚔️")
...
@bot.message_handler(func=lambda message: message.text in ["⚔️ START 🔥VKP🔥 ATTACK ⚔️", "RULES ℹ️", "MY LOGS 📝", "HELP ❓", "BUY PLAN 🛒"])
def handle_user_buttons(message):
    user_id = str(message.chat.id)
    
    if user_id in allowed_user_ids:
        if message.text == "⚔️ START 🔥VKP🔥 ATTACK ⚔️":
            handle_bgmi(message)
...
@bot.message_handler(func=lambda message: message.text in ["⚔️ START 🔥VKP🔥 ATTACK ⚔️", "LOGS 📊", "ALL USERS 👥", "CLEAR LOGS 🗑️"])
